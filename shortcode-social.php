	...
	<ul class="ok-shortcode-social-list">
		<li class="ok-icon-wrapper ok-icon-facebook">
			...
			<a href="https://twitter.com/leelb"
			   onclick="ga('send', 'event', 'Custom Events', 'Click', 'Twitter content follow link');">
			...
			<a href="https://www.instagram.com/leanneebrown/"
			   onclick="ga('send', 'event', 'Custom Events', 'Click', 'Instagram content follow link');">
			...
			<a href="https://www.pinterest.com/leanneebrown/"
			   onclick="ga('send', 'event', 'Custom Events', 'Click', 'Pinterest content follow link');">
